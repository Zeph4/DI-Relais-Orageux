/*
 Leaflet 1.0.0-beta.2 (e0c17bf), a JS library for interactive maps. http://leafletjs.com
...
! function(t, e, i) {
    ...
    s.addEventListener = s.on, s.removeEventListener = s.clearAllEventListeners = s.off, s.addOneTimeEventListener = s.once, s.fireEvent = s.fire, s.hasEventListeners = s.listens, o.Mixin = {
        ...
        function() {
            ...
            stop: function() {
                return this.setZoom(this._limitZoom(this._zoom)), this._stop()
            },
            ...
            getBoundsZoom: function(t, e, i) {
                ...
                return n = this.getScaleZoom(d, n), c && (n = e ? Math.ceil(n / c) * c : Math.floor(n / c) * c), Math.max(s, Math.min(r, n))
            },
            getSize: function() {
            ...
            initialize: function(t, e) {
                if (o.setOptions(this, e), this._latlng = o.latLng(t), isNaN(this.options.radius)) throw new Error("Circle radius cannot be NaN");
            ...
            return "number" == typeof e && (e = o.extend({}, i, {
                radius: e
            })), new o.Circle(t, e)
    ...
    o.DomEvent = {
        ...
        _onTouchEnd: function() {
            return this._moved && this._zooming ? (this._zooming = !1, o.Util.cancelAnimFrame(this._animRequest), o.DomEvent.off(e, "touchmove", this._onTouchMove).off(e, "touchend", this._onTouchEnd), void this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.snapZoom)) : void(this._zooming = !1)
        }
    ...
    h && o.Map.addInitHook(function() {
        ...
        flyTo: function(t, e, n) {
            ...
            var g = Math.max(p.x, p.y),
                ...
                b = Date.now(),
                w = (s(1) - x) / P,
                D = n.duration ? 1e3 * n.duration : 1e3 * w * .8;
