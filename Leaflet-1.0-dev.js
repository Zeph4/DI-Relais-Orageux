...
! function(t, e, i) {
    ...
    s.addEventListener = s.on, s.removeEventListener = s.clearAllEventListeners = s.off, s.addOneTimeEventListener = s.once, s.fireEvent = s.fire, s.hasEventListeners = s.listens, o.Mixin = {
        ...
        function() {
            ...
            o.DomUtil.disableImageDrag = function() {
                ...
                e && (o.DomUtil.restoreOutline(), this._outlineElement = e, this._outlineStyle = e.style.outline, e.style.outline = "none", o.DomEvent.on(t, "keydown", o.DomUtil.restoreOutline, this))
            ...
            _move: function(t, e, n) {
                e === i && (e = this._zoom);
                var o = this._zoom !== e;
                return this._zoom = e, this._lastCenter = t, this._pixelOrigin = this._getNewPixelOrigin(t), o && this.fire("zoom", n), this.fire("move", n)
            },
            _moveEnd: function(t) {
            ...
            _initEvents: function(e) {
                if (o.DomEvent) {
                    ...
                    var i = e ? "off" : "on";
                    o.DomEvent[i](this._container, "click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keypress", this._handleDOMEvent, this), this.options.trackResize && o.DomEvent[i](t, "resize", this._onResize, this)
                }
            },
            _onResize: function() {
            ...
            _findEventTargets: function(t, e, i) {
                for (var n, s = []; t && (n = this._targets[o.stamp(t)], !n || !n.listens(e, !0) || (s.push(n), i)) && t !== this._container;) t = t.parentNode;
                return s
            },
            ...
            _fireDOMEvent: function(t, e, i) {
                ...
                var n = "mouseover" === e || "mouseout" === e;
                if (i = (i || []).concat(this._findEventTargets(t.target || t.srcElement, e, !n)), i.length || (i = [this], !n || o.DomEvent._checkMouse(this._container, t))) {
                    var s = i[0];
                    if ("click" !== t.type || t._simulated || !this._draggableMoved(s)) {
                        var r = {
                            originalEvent: t
                        };
                        if ("keypress" !== t.type) {
                ...
                if (this._map) {
                    ...
                    for (var s in this._tiles) {
                        ...
                        if (r.current && r.loaded) {
                            var a = Math.min(1, (e - r.loaded) / 200);
                            1 > a ? (o.DomUtil.setOpacity(r.el, t * a), i = !0) : (o.DomUtil.setOpacity(r.el, t), r.active && (n = !0), r.active = !0)
                        }
                    }
                    n && this._pruneTiles(), i && (o.Util.cancelAnimFrame(this._fadeFrame), this._fadeFrame = o.Util.requestAnimFrame(this._updateOpacity, this))
                }
            },
            ...
            _setView: function(t, e, i, n) {
                var s = Math.round(e),
                    r = this._tileZoom !== s;
                !n && r && (this._abortLoading && this._abortLoading(), this._tileZoom = s, this._updateLevels(), this._resetGrid(), o.Browser.mobileWebkit || this._update(t, s), i || this._pruneTiles()), this._setZoomTransforms(t, e)
            },
            ...
            _resetGrid: function() {
                ...
                o && (this._globalTileRange = this._pxBoundsToTileRange(o)), this._wrapX = e.wrapLng && [Math.floor(t.project([0, e.wrapLng[0]], n).x / i.x), Math.ceil(t.project([0, e.wrapLng[1]], n).x / i.y)], this._wrapY = e.wrapLat && [Math.floor(t.project([e.wrapLat[0], 0], n).y / i.x), Math.ceil(t.project([e.wrapLat[1], 0], n).y / i.y)]
            },
            _onMoveEnd: function() {
            ...
            _update: function(t, n) {
                var s = this._map;
                if (s) {
                    t === i && (t = s.getCenter()), n === i && (n = s.getZoom());
                    var r = Math.round(n);
                    if (!(r > this.options.maxZoom || r < this.options.minZoom)) {
                        var a = this._getTiledPixelBounds(t, n, r),
                            h = this._pxBoundsToTileRange(a),
                            l = h.getCenter(),
                            u = [];
                        for (var c in this._tiles) this._tiles[c].current = !1;
                        for (var d = h.min.y; d <= h.max.y; d++)
                            for (var _ = h.min.x; _ <= h.max.x; _++) {
                                var m = new o.Point(_, d);
                                if (m.z = r, this._isValidTile(m)) {
                                    var p = this._tiles[this._tileCoordsToKey(m)];
                                    p ? p.current = !0 : u.push(m)
                                }
                            }
                        if (u.sort(function(t, e) {
                            ...
                            var f = e.createDocumentFragment();
                            for (_ = 0; _ < u.length; _++) this._addTile(u[_], f);
            ...
            _addTile: function(t, e) {
                ...
                this._initTile(s), this.createTile.length < 2 && setTimeout(o.bind(this._tileReady, this, t, null, s), 0), o.DomUtil.setPosition(s, i), this._tiles[n] = {
                    el: s,
                    coords: t,
                    current: !0
            ...
            _abortLoading: function() {
                var t, e;
                for (t in this._tiles) e = this._tiles[t].el, e.onload = o.Util.falseFn, e.onerror = o.Util.falseFn, e.complete || (e.src = o.Util.emptyImageUrl, o.DomUtil.remove(e))
            }
            ...
            _initIcon: function() {
                var t = this.options,
                    ...
                    n = !1;
                i !== this._icon && (this._icon && this._removeIcon(), n = !0, t.title && (i.title = t.title), t.alt && (i.alt = t.alt)), o.DomUtil.addClass(i, e), t.keyboard && (i.tabIndex = "0"), this._icon = i, this._initInteraction(), t.riseOnHover && this.on({
            ...
            removeLayer: function(t) {
                return this.hasLayer(t) ? (t in this._layers && (t = this._layers[t]),
                    t.removeEventParent(this), o.LayerGroup.prototype.removeLayer.call(this, t), this.fire("layerremove", {
                        layer: t
                    })) : this
            },
            setStyle: function(t) {
            ...
            _animateZoom: function(t) {
                var e = this._map.getZoomScale(t.zoom, this._zoom),
                    i = this._map._latLngToNewLayerPoint(this._topLeft, t.zoom, t.center);
                o.DomUtil.setTransform(this._container, i, e)
            },
            _updateTransform: function() {
                var t = this._map.getZoom(),
                    e = this._map.getCenter(),
                    i = this._map.getZoomScale(t, this._zoom),
                    n = this._map._latLngToNewLayerPoint(this._topLeft, t, e);
                o.DomUtil.setTransform(this._container, n, i)
            },
            _reset: function() {
            ...
            _update: function() {
                ...
                this._bounds = new o.Bounds(i, i.add(e.multiplyBy(1 + 2 * t)).round()), this._topLeft = this._map.layerPointToLatLng(i), this._zoom = this._map.getZoom()
            }
        }), o.Map.include({
            ...
            _initContainer: function() {
                ...
                o.DomEvent.on(t, "mousemove", this._onMouseMove, this).on(t, "click dblclick mousedown mouseup contextmenu", this._onClick, this).on(t, "mouseout", this._handleMouseOut, this), this._ctx = t.getContext("2d")
            },
            _update: function() {
                if (!this._map._animatingZoom || !this._bounds) {
                    o.Renderer.prototype._update.call(this);
            ...
            _onClick: function(t) {
                ...
                for (var i in this._layers) this._layers[i]._containsPoint(e) && (o.DomEvent._fakeStop(t), this._fireEvent(this._layers[i], t))
            },
            ...
            _handleMouseHover: function(t, e) {
                ...
                if (!this._hoveredLayer)
                    for (i in this._layers)
                        if (n = this._layers[i], n.options.interactive && n._containsPoint(e)) {
                            o.DomUtil.addClass(this._container, "leaflet-interactive"), this._fireEvent(n, t, "mouseover"), this._hoveredLayer = n;
                            break
                        }
    ...
    o.DomEvent = {
        ...
        addDoubleTapListener: function(t, e, i) {
            ...
            var r, a, h = !1,
                ...
                c = this._touchstart,
                d = this._touchend;
            return t[u + c + i] = n, t[u + d + i] = s, t.addEventListener(c, n, !1), t.addEventListener(d, s, !1), this
        },
        removeDoubleTapListener: function(t, e) {
            var i = "_leaflet_",
                n = t[i + this._touchend + e];
            return t.removeEventListener(this._touchstart, t[i + this._touchstart + e], !1), t.removeEventListener(this._touchend, n, !1), this
        }
    }), o.extend(o.DomEvent, {
        ...
        _onTouchMove: function(t) {
            if (t.touches && 2 === t.touches.length && this._zooming) {
                ...
                if (this._zoom = e.getScaleZoom(s, this._startZoom), "center" === e.options.touchZoom) {
                ...
                if (e.options.bounceAtZoomLimits || !(this._zoom <= e.getMinZoom() && 1 > s || this._zoom >= e.getMaxZoom() && s > 1)) {
                    ...
                    this._animRequest = o.Util.requestAnimFrame(a, this, !0, e._container), o.DomEvent.preventDefault(t)
                }
            }
        },
        ...
        _onMouseDown: function(t) {
            return !t.shiftKey || 1 !== t.which && 1 !== t.button ? !1 : (this._moved = !1, o.DomUtil.disableTextSelection(), o.DomUtil.disableImageDrag(), this._startPoint = this._map.mouseEventToContainerPoint(t), void o.DomEvent.on(e, {
        ...
        addHooks: function() {
            var t = this._map._container; - 1 === t.tabIndex && (t.tabIndex = "0"), o.DomEvent.on(t, {
                focus: this._onFocus,
                blur: this._onBlur,
        ...
        _onInputClick: function() {
            ...
            for (var r = 0, a = n.length; a > r; r++) t = n[r], e = this._layers[t.layerId].layer, i = this._map.hasLayer(e), t.checked && !i ? o.push(e) : !t.checked && i && s.push(e);
        ...
        _expand: function() {
            ...
            t < this._form.clientHeight && (o.DomUtil.addClass(this._form, "leaflet-control-layers-scrollbar"), this._form.style.height = t + "px")
        },
        _collapse: function() {
        ...
        _tryAnimatedPan: function(t, e) {
            ...
            return (e && e.animate) === !0 || this.getSize().contains(i) ? (this.panBy(i, e), (e && e.animate) !== !1) : !1
        }
    }), o.Map.mergeOptions({
        zoomAnimation: !0,
    ...
    h && o.Map.addInitHook(function() {
        ...
        _onZoomTransitionEnd: function() {
            this._animatingZoom = !1, o.DomUtil.removeClass(this._mapPane, "leaflet-zoom-anim"), this._move(this._animateToCenter, this._animateToZoom)._moveEnd(!0)
        }
    } : {}), o.Map.include({
        flyTo: function(t, e, n) {
            function s(t) {
                var e = (v * v - g * g + (t ? -1 : 1) * L * L * y * y) / (2 * (t ? v : g) * L * y);
            ...
            function d() {
                var i = (Date.now() - b) / T,
                    n = c(i) * w;
                1 >= i ? (this._flyToFrame = o.Util.requestAnimFrame(d, this), this._move(this.unproject(_.add(m.subtract(_).multiplyBy(u(n) / y)), f), this.getScaleZoom(g / l(n), f))) : this._move(t, e)._moveEnd(!0)
            }
